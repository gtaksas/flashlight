...
def store():
    ...
    (market, brand, model, entity, engine, price, horsepower, bodystyle, serie, fuel, consumption, emission_co2, transmission, transmission_type, driveline, reaerstring, matchstring, datasource, datum)
